...
a persistence unit "delandePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "delande/pom.xml":
...
artifact ("delande.war") is already built. You can build
